  ...
  const [chatMessages, setchatMessages] = useState([
    {
      ...
      message: "Hello there,I am Lizzy your Contract Assistant. How can i help you today? ",
    },
  ]);
  ...
  return (
    <div>
      ...
      <div className="landing">
        ...
        <div >
           <h1>Your AI Contract Assistant</h1>
           <p>The next generation contract AI, right in Microsoft Word. Draft and review contracts better and faster!</p>
        </div>
      </div>
      <div>
